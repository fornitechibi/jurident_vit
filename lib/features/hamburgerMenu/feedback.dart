...
class _FeedbackPageState extends State<FeedbackPage> {
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference form = FirebaseFirestore.instance.collection("feedback");
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.only(
                                      ...
                                      top: height * 0.03,
                                      right: width * 0.3),
                                  child: Text("FEEDBACK FORM",style: TextStyle(fontSize: 23,color: themeProvider.isDarkMode?backColor:darkModeButtonColor),),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(
                                      left: width * 0.08,
                                      top: height * 0.01,
                                      right: width * 0.1),
                                  child: Text("We want to hear from you! Your feedback is important to us and helps us improve our application.",style: TextStyle(fontSize: 13,color: themeProvider.isDarkMode?backColor:Colors.white),),
                                ),
                                ...
                                Padding(
                                  padding: EdgeInsets.only(
                                      ...
                                      top: height * 0.004),
                                  child: Theme(
                                    data: ThemeData(hintColor: themeProvider.isDarkMode?backColor:Colors.white),
                                    child:  TextFormField(
                                ...
                                Padding(
                                  ...
                                  child: TextButton(
                                      ...
                                      child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              color: backColor,
                                              border: Border.all(color: darkModeButtonColor),
                                              borderRadius:
